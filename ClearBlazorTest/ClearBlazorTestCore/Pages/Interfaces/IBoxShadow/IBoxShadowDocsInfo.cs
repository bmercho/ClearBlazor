...
namespace ClearBlazorTest
{
    public record IBoxShadowDocsInfo:IOtherDocsInfo
    {
        ...
        public string Description {get; set; } = "Defines a box shadow surrounding a component.\rNote that it is drawn outside of the component so there needs to space around the component to show the box shadow.\rSet a padding if there is no room to show it.\r";
