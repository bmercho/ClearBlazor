...
namespace ClearBlazorTest
{
    public record ListViewDocsInfo:IComponentDocsInfo
    {
        ...
        public List<ApiComponentInfo> ParameterApi {get; set; } = new List<ApiComponentInfo>
        {
            ...
            new ApiComponentInfo("PageSize", "int", "10", "Approximately the number of rows that will fit in the ScrollViewer.\rAdjust this until this number at least fills a page.\rShould be too large rather that to small.\rOnly used if VirtualizationMode is InfiniteScroll or Pagination.\r"),
        };
