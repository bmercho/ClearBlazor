...
namespace ClearBlazorTest
{
    public record NonVirtualizedListDocsInfo:IComponentDocsInfo
    {
        ...
        public string Description {get; set; } = "Displays a list of items( of type 'IItem') inside a ScrollViewer which is embedded in this component.\rUse this component if virtualization is not required, the item heights are the same \rand the number of items are known.\rOtherwise use VirtualizedList or InfiniteScrollerList component.\r";
