...
namespace ClearBlazorTest
{
    public record TableViewDocsInfo:IComponentDocsInfo
    {
        ...
        public List<ApiComponentInfo> ParameterApi {get; set; } = new List<ApiComponentInfo>
        {
            ...
            new ApiComponentInfo("RowHeight", "int", "30", "The height to be used for each item.\rThis is only used if the VirtualizeMode is Virtualize.\r"),
            ...
            new ApiComponentInfo("ColumnDefs", "string", "", "Defines the column layout for the table. Similar to the Grid Columns property.\r"),
